...
try {
    $query = "SELECT * FROM service_bookings WHERE booking_code = :code OR id = :id";
...
<body>
    <div class="payment-method-container">
        ...
        <div class="booking-summary">
            ...
            <div class="summary-row">
                <span><i class="fas fa-calendar me-2"></i>Ngày Sử Dụng:</span>
                <strong><?php echo date('d/m/Y', strtotime($booking['booking_date'])); ?></strong>
            </div>
            <div class="summary-row">
                <span><i class="fas fa-users me-2"></i>Số Lượng:</span>
                <strong><?php echo $booking['quantity']; ?> người</strong>
            </div>
            <div class="summary-row">
        ...
        <div class="payment-content">
            ...
            <form id="paymentMethodForm" method="POST" action="payment-service-form.php">
