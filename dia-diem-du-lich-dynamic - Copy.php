        ...
        <div class="header-content">
            ...
            <div class="nav-section">
                <nav class="main-nav">
                    ...
                    <a href="quan-ly-booking.php" class="nav-link" style="color: #f59e0b;">
                        <i class="fas fa-calendar-check"></i> Quản Lý Đặt Tour
                    </a>
                </nav>

                <div style="display: flex; gap: 10px;">
                    <a href="dang-nhap.php" class="cta-button" style="background: #3b82f6;">
                        <i class="fas fa-sign-in-alt"></i> Đăng Nhập
                    </a>
                    <a href="quan-ly-users.php" class="cta-button" style="background: #8b5cf6;">
  ...
  <section class="hero-section">
    <div class="hero-content">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            <div>
                <h1 class="hero-title" style="margin-bottom: 0;">Khám Phá Trà Vinh</h1>
            </div>
            <a href="test-add-attraction.php" 
               class="btn-add-attraction"
