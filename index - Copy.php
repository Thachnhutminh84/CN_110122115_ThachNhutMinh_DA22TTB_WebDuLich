...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-red-600 hover:text-red-700 transition-colors">
                            TRƯỜNG ĐẠI HỌC TRÀ VINH
                        </h1>
                        <p class="text-gray-600 text-sm mt-1" id="headerDateTime">
    ...
    <!-- Navigation Menu Bar -->
    <nav class="bg-gradient-to-r from-blue-600 to-green-600 shadow-md sticky top-[88px] z-40">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-center">
                <ul class="flex flex-wrap items-center justify-center gap-1 py-3">
                    <!-- Địa Điểm Du Lịch -->
                    <li>
                        <a href="dia-diem-du-lich-dynamic.php" 
                           class="flex items-center gap-2 px-6 py-3 text-white font-semibold hover:bg-white/20 rounded-lg transition-all duration-300 transform hover:scale-105">
    ...
    <div class="main-content-wrapper">
        <nav class="relative w-full h-[600px] overflow-hidden shadow-lg">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-white max-w-6xl mx-auto px-4">
                    <!-- Main Title -->
                    <h1 class="text-6xl md:text-8xl font-bold mb-8 animate-fade-in">
                        <span class="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">
                            Du Lịch Trà Vinh
                        </span>
                    </h1>

                    <p class="text-2xl md:text-3xl mb-12 animate-fade-in-delay opacity-90">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
                        ...
                        <a href="dia-diem-du-lich-dynamic.php" class="nav-card group">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 shadow-2xl">
                                ...
                                <h3 class="text-2xl font-bold mb-3">Địa Điểm Du Lịch</h3>
                                <p class="text-lg opacity-90 mb-4">Khám phá <?php echo $attractionCount; ?> di tích lịch sử, chùa Khmer cổ kính</p>
                        ...
                        <a href="am-thuc.php" class="nav-card group">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 shadow-2xl">
                                ...
                                <h3 class="text-2xl font-bold mb-3">Ẩm Thực</h3>
                                <p class="text-lg opacity-90 mb-4">Thưởng thức đặc sản Khmer độc đáo, hương vị đậm đà</p>
                                <div class="flex items-center justify-center text-yellow-400 group-hover:text-yellow-300">
                                    <span class="mr-2">Thưởng thức</span>
                                    <i class="fas fa-arrow-right group-hover:translate-x-2 transition-transform"></i>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="lien-he.php" class="nav-card group">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 shadow-2xl">
                                ...
                                <h3 class="text-2xl font-bold mb-3">Liên Hệ</h3>
                                <p class="text-lg opacity-90 mb-4">Tư vấn du lịch, đặt tour và hỗ trợ khách hàng</p>
                                <div class="flex items-center justify-center text-yellow-400 group-hover:text-yellow-300">
                        ...
                        <a href="dang-nhap.php" class="nav-card group">
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 shadow-2xl">
                                ...
                                <h3 class="text-2xl font-bold mb-3">Đăng Nhập</h3>
                                <p class="text-lg opacity-90 mb-4">Truy cập tài khoản để đặt tour và quản lý</p>
                                <div class="flex items-center justify-center text-yellow-400 group-hover:text-yellow-300">
                    ...
                    <!-- Quick Stats -->
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 animate-fade-in-delay-2">
                        <div class="text-center">
                            <div class="text-4xl font-bold text-yellow-400 mb-2"><?php echo $stats['temples']; ?></div>
                            <div class="text-lg opacity-90">Chùa Khmer</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-yellow-400 mb-2"><?php echo $stats['visitors']; ?></div>
                            <div class="text-lg opacity-90">Lượt Khách/Năm</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-yellow-400 mb-2"><?php echo $stats['heritage_sites']; ?></div>
                            <div class="text-lg opacity-90">Di Tích Lịch Sử</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-yellow-400 mb-2"><?php echo $stats['ethnic_groups']; ?></div>
                            <div class="text-lg opacity-90">Dân Tộc Hòa Hợp</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 bg-gradient-to-br from-blue-50 to-green-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Điểm Đến Nổi Bật</h2>
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 group">
                    <div class="relative h-64 overflow-hidden">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-<?php echo $index === 0 ? 'red' : ($index === 1 ? 'orange' : 'green'); ?>-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
